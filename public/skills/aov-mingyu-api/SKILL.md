...
奇门解读涉及象意转换或现实条件调整时，按需读取 [奇门取象、换象与造象](references/qimen-images.md)，先固定原用神，再展开转换分支与条件方案。
...
- **包含内容**：
  ...
  - 皇极经世六日逐爻公历时间必须同时有经校定的当地子半历元与 `six-day-explicit-epoch` 口径，按当地日期差进入三百六十日坐标；
