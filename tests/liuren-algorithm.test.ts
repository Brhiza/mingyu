...
test('大六壬十四项岁神煞应按年支完整循环，并与同位别名及其他层级分开', () => {
  const cases = [
    [
      2020,
      '子',
      ['子', '午', '巳', '亥', '寅', '戌', '戌', '申', '卯', '酉', '未', '辰', '戌', '未'],
    ],
    [
      2021,
      '丑',
      ['丑', '未', '午', '子', '卯', '亥', '亥', '酉', '戌', '酉', '申', '丑', '未', '辰'],
    ],
    [
      2022,
      '寅',
      ['寅', '申', '未', '丑', '辰', '子', '子', '戌', '巳', '子', '酉', '戌', '辰', '丑'],
    ],
    [
      2023,
      '卯',
      ['卯', '酉', '申', '寅', '巳', '丑', '丑', '亥', '子', '子', '戌', '未', '丑', '戌'],
    ],
    [
      2024,
      '辰',
      ['辰', '戌', '酉', '卯', '午', '寅', '寅', '子', '辰', '子', '亥', '辰', '戌', '未'],
    ],
    [
      2025,
      '巳',
      ['巳', '亥', '戌', '辰', '未', '卯', '卯', '丑', '申', '卯', '子', '丑', '未', '辰'],
    ],
    [
      2026,
      '午',
      ['午', '子', '亥', '巳', '申', '辰', '辰', '寅', '午', '卯', '丑', '戌', '辰', '丑'],
    ],
    [
      2027,
      '未',
      ['未', '丑', '子', '午', '酉', '巳', '巳', '卯', '丑', '卯', '寅', '未', '丑', '戌'],
    ],
    [
      2028,
      '申',
      ['申', '寅', '丑', '未', '戌', '午', '午', '辰', '寅', '午', '卯', '辰', '戌', '未'],
    ],
    [
      2029,
      '酉',
      ['酉', '卯', '寅', '申', '亥', '未', '未', '巳', '酉', '午', '辰', '丑', '未', '辰'],
    ],
    [
      2030,
      '戌',
      ['戌', '辰', '卯', '酉', '子', '申', '申', '午', '未', '午', '巳', '戌', '辰', '丑'],
    ],
    [
      2031,
      '亥',
      ['亥', '巳', '辰', '戌', '丑', '酉', '酉', '未', '亥', '酉', '午', '未', '丑', '戌'],
    ],
  ] as const;
  const names = [
    '太岁',
  ...
  for (const [year, yearBranch, targets] of cases) {
    ...
    assert.ok(
      ['大耗', '破煞', '岁宅', '太阴', '白虎', '将军', '豹尾'].every((name) => !facts.has(name)),
...
test('大六壬已登记神煞应覆盖十二月建与六十日柱固定表', () => {
  ...
  const finalAuditedMonthTargets: Record<string, readonly string[]> = {
    寅: ['未', '亥', '卯', '酉', '戌', '丑', '卯', '寅', '辰', '辰', '辰', '戌', '巳', '丑', '寅'],
    卯: ['辰', '午', '卯', '酉', '戌', '寅', '子', '卯', '辰', '巳', '戌', '未', '辰', '丑', '丑'],
    辰: ['丑', '丑', '卯', '酉', '戌', '卯', '酉', '辰', '辰', '午', '丑', '辰', '卯', '丑', '子'],
    巳: ['戌', '申', '午', '子', '未', '辰', '午', '巳', '未', '未', '未', '丑', '寅', '子', '亥'],
    午: ['未', '卯', '午', '子', '未', '巳', '卯', '午', '未', '申', '辰', '戌', '丑', '子', '戌'],
    未: ['辰', '戌', '午', '子', '未', '午', '子', '未', '未', '酉', '戌', '未', '子', '子', '酉'],
    申: ['丑', '巳', '酉', '卯', '辰', '未', '酉', '申', '戌', '戌', '丑', '辰', '亥', '戌', '申'],
    酉: ['戌', '子', '酉', '卯', '辰', '申', '午', '酉', '戌', '亥', '未', '丑', '戌', '戌', '未'],
    戌: ['未', '未', '酉', '卯', '辰', '酉', '卯', '戌', '戌', '子', '辰', '戌', '酉', '戌', '午'],
    亥: ['辰', '寅', '子', '午', '丑', '戌', '子', '亥', '丑', '丑', '戌', '未', '申', '亥', '巳'],
    子: ['丑', '酉', '子', '午', '丑', '亥', '酉', '子', '丑', '寅', '丑', '辰', '未', '亥', '辰'],
    丑: ['戌', '辰', '子', '午', '丑', '子', '午', '丑', '丑', '卯', '未', '丑', '午', '亥', '卯'],
  };
