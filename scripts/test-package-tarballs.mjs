...
// 四小行星、兼容边缘运行时的固定星历数据及文字数理能力均随核心包发布；
// 仍保留明确上限（2.26 MB），防止后续依赖或构建产物无意混入发布包。
const CORE_TARBALL_MAX_BYTES = 2_260_000;
...
try {
  ...
  assert.ok(
    ...
    `mingyu-core 压缩包不应超过 2.26 MB：${coreTarballBytes} 字节`,
  );
