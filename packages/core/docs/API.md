...
**返回 `LiurenData`：** 含月将（中气换将）、昼夜贵人、天地盘、四课、三传（初传/中传/末传，含九宗门取传法）、已审核神煞、天将属性、30 条已校勘课体规则与旬空。课体只是可复算盘面事实，不直接生成吉凶结论。

### `getLiurenGuaTiFacts(context)` / `getLiurenTransmissionGuaTi(branches)`

识别已登记的课体事实或课体名称。三传必须恰好包含三个合法地支；三传天将一经提供也必须恰好包含三个合法十二天将；四课一经提供就必须完整包含四课，课上神须为地支，课下位须为天干或地支；日柱、日干、日支、占时、月建、大吉落地等可选上下文一经提供也须合法且不得互相矛盾，缺少九丑、天网、上门乱首、赘婿、回环、游子、泆女、狡童、六仪、旬三奇等专项规则所需条件时不会猜测命中。非法、残缺或超长输入会直接报错。当前只开放 30 条完成原文与条件校勘的规则，不代表传统课体总目录已经穷尽。

课体命中边界已独立穷举全部 1,728 种三传排列，进茹、退茹分别只命中其中 12 种逐支顺逆组合，进间、退间分别只命中其中 12 种隔位顺逆组合；回环穷举 793 种四课上神集合与全部三传组成的 1,370,304 种轮廓，赘婿按 10 日干 × 12 日支 × 12 干上神 × 12 初传共 17,280 组穷举，游子按 12 月建 × 1,728 种三传共 20,736 组穷举；四课克贼课体另穷举五种关系的 5⁴＝625 组轮廓；天网按 10 日干 × 12 占时 × 12 初传共 1,440 组穷举，上门乱首按 17,280 组穷举；九丑按 60 日柱 × 12 占时 × 12 大吉所临地盘 × 2 种发用共 17,280 组穷举，六仪与旬三奇按 60 日柱 × 12 初传共 720 组穷举。游子只取三传皆为辰戌丑未且月建天马发用的多源共同条件，不采用仅三传皆土、仅旬丁发用或驿马发用即可命名的扩展版本；赘婿只取日支临干受干克且以日支发用的多源交集，九丑只取十个指定日柱、四仲时与天盘大吉丑临本日支三项交集，丑发用依正文，未发用依《订讹》分支并明确区分，仪奇只取《六壬指南》明确的旬首或旬奇发用条件。官爵、龙首、龙战、天狱、芜淫等因版本条件分歧或缺少行年、旺衰层级等必要资料继续失败关闭。上述规则只登记中性结构事实，不继承原典现实断语。120 条均有直接结构穷举；其中 115 条可由当前主版本九宗门合法排盘产生，出三天格、入三渊格、凝阳格、涉疑格、偃蹇格五条间传专名保留版本边界。完整排盘另验证 17,280 组月将、占时、日柱、昼夜组合，以及加入十二太岁后的 207,360 个课体上下文。
