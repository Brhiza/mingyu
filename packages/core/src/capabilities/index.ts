...
const systems: SystemCapability[] = [
  ...
  },
  {
    ...
    notes: [
      '当前实现年度固定表结构，不含精确交运时刻、天符岁会等派生格局，也不替代气象资料或医疗诊断。',
    ],
  },
  {
    id: 'huangji-jingshi',
    ...
    inputs: [
      ...
      },
      {
        ...
        type: 'number',
        required: false,
        description: '0 表示纪元第一年；与目标年坐标二选一。',
      },
      questionInput,
    ],
    outputs: [
    ...
    notes: [
      '纪元必须由调用方明确提供；整数坐标不自动解释为公元或其他纪年。当前不含值年卦与事件预测。',
    ],
  },
  {
    id: 'qizheng',
