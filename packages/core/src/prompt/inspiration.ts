...
export const LIUYAO_TEMPLATE_INSPIRATION_CONTENT: Record<
  Exclude<DivinationInspirationDraft['liuyaoTemplate'], 'general'>,
  DivinationInspirationSection[]
> = {
  ganqing: [
    {
...
export const LIUREN_TEMPLATE_INSPIRATION_CONTENT: Record<
  Exclude<DivinationInspirationDraft['liurenTemplate'], 'general'>,
  DivinationInspirationSection[]
> = {
  ganqing: [
    {
...
export const LENORMAND_SPREAD_INSPIRATION_CONTENT: Record<
  DivinationInspirationDraft['lenormandSpread'],
  DivinationInspirationSection[]
> = {
  single: [
    {
...
export const TAROT_SPREAD_INSPIRATION_QUESTIONS: Partial<
  Record<DivinationInspirationDraft['tarotSpread'], string[]>
> = {
  single: [
    '今天我需要关注什么？',
    '我现在最需要的指引是什么？',
...
export function getDivinationSpecialInspiration(
  draft: Pick<
    DivinationInspirationDraft,
    'method' | 'liuyaoTemplate' | 'liurenTemplate' | 'lenormandSpread'
  >,
...
export function isDivinationInspirationTabVisible(
  ...
  draft: DivinationInspirationDraft,
) {
  if (tabId === 'spread') {
...
export function resolveDivinationInspiredDraftPatch(
  current: DivinationInspirationDraft,
  question: string,
