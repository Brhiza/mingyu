export const PROMPT_GUIDANCE_TEXT = {
  ...
  xiaoliuren: {
    tradition:
      '正月从大安起，月上起初一，日上起子时，依大安、留连、速喜、赤口、小吉、空亡顺行；时宫为本次占得宫，月宫与日宫只承担逐宫顺数。',
  ...
  qizheng: {
    tradition: '七政四余以二十八宿、命身宫、星曜落宫与主要吊照为主。',
  ...
  xuankong: {
    tradition: '先按下卦定三元九运与二十四山向，再结合运盘、山盘、向盘、到山到向和局型判断。',
...
export const PROMPT_METHOD_ANSWER_FRAMEWORKS: Record<string, string> = {
  ...
  astrolabe:
    '先以太阳、月亮、上升与主要相位格局定本命底色；有行运或周期星象资料时，再结合时限推演阶段触发。',
  'astrolabe-natal': '先以太阳、月亮、上升与主要相位格局定本命底色与结构关系。',
  'astrolabe-synastry':
    '先分别确立双方本命结构与关系需求，再结合跨盘相位与重要落宫推演互动张力与长期承接。',
  qizheng:
    '先以命身宫度与十一星落宿定本命根基，再依三方吊照与度数生克详析吉凶。本盘为出生时点静态结构。',
