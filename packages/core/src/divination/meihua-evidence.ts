...
export interface MeihuaObjectContextFact {
  ...
  promptText: string;
  sources: string[];
  limitation: '《观物玄妙歌诀》《占物类例》《物数为体诀》《观物看变爻为主》与《观物克应法》只适用于明确的观物、射覆或具体物件辨识；原文可确认爻辞、八卦象、体用生克、用变互色数、多卦取体、阴阳爻多少、五六爻动、乾卦前三爻变后响应及成卦未决时圆物、负土、刚健、柔腐等现场候选资料层级。但当前输入没有专项情境和现场原始观察，底本又存在艮离错题、爻辞异文、句读冲突、统计范围、生旺口径、不入五行物句义、变爻与变卦名义、三例覆盖、多种取主口径优先顺序及物之成败、体卦克应、偶见物取舍等未决问题。不得据规则目录或普通盘面生成主导卦、主导五行、物件种类、材质、形状、颜色、气味、软硬、动静、位置、完整缺损、价值、可用可食、成败结果或精确数量等结论';
}
...
const OBJECT_CONTEXT_FACT_LIMITATION =
  '《观物玄妙歌诀》《占物类例》《物数为体诀》《观物看变爻为主》与《观物克应法》只适用于明确的观物、射覆或具体物件辨识；原文可确认爻辞、八卦象、体用生克、用变互色数、多卦取体、阴阳爻多少、五六爻动、乾卦前三爻变后响应及成卦未决时圆物、负土、刚健、柔腐等现场候选资料层级。但当前输入没有专项情境和现场原始观察，底本又存在艮离错题、爻辞异文、句读冲突、统计范围、生旺口径、不入五行物句义、变爻与变卦名义、三例覆盖、多种取主口径优先顺序及物之成败、体卦克应、偶见物取舍等未决问题。不得据规则目录或普通盘面生成主导卦、主导五行、物件种类、材质、形状、颜色、气味、软硬、动静、位置、完整缺损、价值、可用可食、成败结果或精确数量等结论' as const;
...
function buildObjectContextFact(): MeihuaObjectContextFact {
  ...
  return {
    ...
    promptText:
      '当前输入未明确观物专项所需情境：现只保留起卦时点与取数、主互变上下经卦、动爻与普通体用、月份与四时旺衰等盘面事实；尚未确认所占确为观物或射覆、待辨物件范围与可见遮覆状态、所需辨识的属性范围，也未记录成卦未决时的现场原始观察及先后次序。《占物类例》第935至938行、《物数为体诀》第939至941行、《观物看变爻为主》第942至943行及《观物克应法》第944至945行已留档，可确认爻辞、八卦象、体用生克、用变互色数、多卦取体、阴阳爻多少、五六爻动、乾卦前三爻变后响应及圆物、负土、刚健、柔腐等现场候选资料层级；但艮离错题、爻辞异文、句读冲突、卦数统计范围、生旺判准、不入五行物句义、变爻与变卦名义、三例覆盖、取主优先顺序、物之成败、体卦克应及偶见物取舍仍未闭合。不得把规则目录套到普通问题，也不得输出主导卦、主导五行、具体物件、材质、形色、状态、价值、可用可食、成败结果或精确数量',
    sources: [
...
function buildLimitationFacts(params: {
  ...
  > = [
    ...
    },
    {
      ...
      promptText:
        '《观物玄妙歌诀》《占物类例》《物数为体诀》《观物看变爻为主》与《观物克应法》须先确认所占确为观物、射覆或具体物件辨识，并明确待辨对象范围、可见遮覆状态和所需属性范围；当前三项情境及成卦未决时现场观察均未输入。原文虽列爻辞、八卦象、体用生克、用变互色数、多卦取体、阴阳爻多少、五六爻动、乾卦前三爻变后响应及圆物、负土、刚健、柔腐等现场候选资料层级，但底本仍有艮离错题、爻辞异文、句读冲突、统计范围、生旺判准、不入五行物句义、变爻与变卦名义、三例覆盖、取主顺序、物之成败、体卦克应及偶见物取舍十六项缺口。不得以问题关键词、规则目录或通用盘面套出主导卦、主导五行、具体物件及其材质、形色、状态、价值、用途、可食性、成败结果或精确数量',
      sources: [
        '《梅花易数》卷三《观物玄妙歌诀》《占物类例》《物数为体诀》《观物看变爻为主》《观物克应法》、通行《周易》爻辞对照与当前观物专项资料覆盖',
      ],
    },
    {
...
export function analyzeMeihuaEvidence(data: MeihuaData): MeihuaEvidenceAnalysis {
  ...
  const items: PromptEvidenceItem[] = [
    ...
    {
      level: '限制',
      title: '观物专项、占物类例、物数为体、变爻与现场克应取象版本覆盖',
  ...
  return {
    ...
    methodology: [
      ...
      '《观物玄妙歌诀》《占物类例》《物数为体诀》《观物看变爻为主》与《观物克应法》只用于明确的观物、射覆或具体物件辨识；须另行明确待辨对象范围、可见遮覆状态、所需属性范围及成卦未决时现场原始观察。这里只登记爻辞、八卦象、体用生克、用变互色数、多卦取体、阴阳爻、五六爻动、乾卦前三爻变后响应及圆物、负土、刚健、柔腐等现场候选规则目录；艮离错题、爻辞异文、句读冲突、数量与卦象统计范围、生旺判准、不入五行物句义、变爻与变卦名义、三例覆盖、取主顺序、物之成败、体卦克应及偶见物取舍未闭合前，不生成主导卦、主导五行、具体物件、形色材质、状态、价值、用途、可食性、成败结果或精确数量。',
