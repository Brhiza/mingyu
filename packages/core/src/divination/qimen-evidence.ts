...
export function analyzeQimenEvidence(input: QimenData): QimenEvidenceAnalysis {
  ...
  const ruleSourceFacts: QimenRuleSourceFact[] = [
    ...
    },
    {
      ...
      status: '已声明',
      category: '经典格局审核边界',
      rule: '正式入口输出已逐条校勘的十一项天地盘固定格，以及仅限时家的伏干格、飞干格、岁格、格勃、三奇升殿、三诈、天假/严格地假/鬼假与玉女守门中性结构；九遁、三奇得使、天辅时、五合时名称、天网/天网四张及三奇/时干入墓已确认存在版本定义冲突，其余三奇、人假、物假、神假、五假扩展、符使、月格、时格、普通勃格及其他旧格局在版本、条件和适用情境闭环前失败关闭',
