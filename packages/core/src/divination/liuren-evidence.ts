...
function buildFoundationConventionFact(): LiurenFoundationConventionFact {
  ...
  return {
    ...
    textualVariantFields: [
      '《六壬神定经》只提供建月与十二月将名称对应，未提供现代精确中气交节时刻；本结果只取其名称映射作互证，不据此替换十二中气实际交节主版本',
    ...
    sources: [
      '《六壬神定经》下卷“释月将第二十三”“释天乙第二十八”“释天官第二十九”“释用式第三十一”',
...
function buildTransmissionConventionFact(): LiurenTransmissionConventionFact {
  return {
    ...
    sources: [
      '《六壬神定经》下卷“释用式第三十一”四课、贼克、比用、涉害、遥克及特殊取法',
