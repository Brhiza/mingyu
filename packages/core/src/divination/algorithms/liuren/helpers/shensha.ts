  ...
  if (monthShenShaIndex >= 0) {
    const monthShenShaTables = [
      ...
      },
      {
        name: '月破',
        targets: ['申', '酉', '戌', '亥', '子', '丑', '寅', '卯', '辰', '巳', '午', '未'],
        rule: '取月建对冲支：正月申、二月酉，顺行至十二月未',
        source: '《六壬神课金口诀古本》月破正申、二酉至十二未完整表',
        extraSources: [
          '《六壬管辂神书》“冲者，即月破是也。正申二酉之类”',
          '《六壬粹言》四破煞及巳年正月申为月破占例',
        ],
        extraLimitations: [
          '本项只按月建取对冲支，与按太岁、日支或时支定位的岁破、日破、时破分层，不互相替代',
          '《六壬粹言》另载“支破”为阳日后三辰、阴日前三辰，属于日支破法，不并入月破',
          '原典成败判断还须结合月破是否入课传、发用、旺衰、吉凶神将及所占事项；本结果只登记月破所在支',
          '不因单项出现自动判断破坏、离散、疾病、诉讼、财物或其他现实结果',
        ],
      },
      {
        name: '皇恩',
  ...
  if (dayStemIndex >= 0 && dayBranchIndex >= 0) {
    ...
    const xunShenShaRules = [
      {
        ...
        extraLimitations: [
          '本项只登记旬首所在支；《六壬大全》《六壬寻源》见“发用或入传”宽口径，当前课体只取《六壬指南》“旬首发用”的严格交集，不因旬仪每日存在或仅见于中末传而自动生成“六仪课”',
    ...
    if (xunQi) {
      addFact({
        ...
        extraLimitations: [
          '本项只登记旬奇所在支；各书对“发用或入传”的范围并不完全一致，当前课体只取《六壬指南》“三奇发用”的严格交集，不因旬奇每日存在或仅见于中末传而自动生成“三奇课”',
