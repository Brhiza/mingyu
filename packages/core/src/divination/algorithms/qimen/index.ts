 ...
 * 4. 识别可复算位置标签、十一项天地盘固定格与四项时家上下文格
 ...
 *
 * 日家奇门以及九遁、三奇、三诈五假、符使、月格、时格、普通勃格等旧规则尚未
 * 完成统一版本、完整条件与适用边界审核，正式入口失败关闭，不据原始盘面自动补算。
 */
 ...
 * 可复算位置标签、已校勘十一项天地盘固定格、四项时家上下文格与中性位置索引。
 *
 * ── 排盘流程 ──
 *
