...
- 奇门排盘结果的 `evidenceAnalysis` 返回值符、值使、日干、时干对应的用神宫候选，以及逐宫门、星、神、天地盘干、已审核时家时旬空、格局、宫间生克、反证、方位条件和时间触发条件。月家、年家旬空及所有自动马星定位因适用层级未闭合而关闭；候选不等于已经按具体问题选定用神，核心结果、公开 API、MCP 与提示词均不返回内部宫位、格局或方位排序分数，也不机械换算绝对日期。
