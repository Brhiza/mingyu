...
四柱干支背景只输出固定六合、六冲、相害、子卯相刑、自刑、天干五合与已登记天干冲，以及三合或三刑的完整三支齐见结构。天干五合、地支六合只登记固定配对、传统化气五行资料及月令状态、透根、位置、冲克和相同配对候选等原始条件；旧固定月份表及“成化、不化、合绊、破合、争合”自动裁决失败关闭。三支齐见不等于成局或合化；半合、拱局及寅巳申、丑戌未任意二支相刑因所需相邻、冲破、透干或版本条件未闭合而失败关闭，原始四柱仍完整保留供 AI 明确口径后继续推算。
