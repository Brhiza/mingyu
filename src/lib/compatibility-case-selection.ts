...
export function applyPersonalCaseToInput(
  ...
  return {
    ...
    birthReverseSource: source.birthReverseSource,
...
export function hydratePersonalCaseInput(
  ...
  return {
    ...
    birthSecond: preciseSource.birthSecond,
    birthReverseSource: preciseSource.birthReverseSource,
...
export function applyPersonalCaseToCompatibilityPerson(
  ...
  if (role === 'partner') {
    return {
      ...
      partnerBirthSecond: source.birthSecond,
      partnerBirthReverseSource: source.birthReverseSource,
