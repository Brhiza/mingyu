...
export type BaziFortuneSelectionModule = typeof import('@temposoul/core/bazi');
...
export type { ZiweiDayOption, ZiweiMonthOption, ZiweiYearOption } from '@temposoul/core/ziwei';
