...
const modeGuides = [
  ...
  {
    title: '干支日历',
    description: '直接浏览本月干支、黄历与节气。',
    bullets: ['切换月份或回到今天', '选择日期查看宜忌与时辰', '交节日可查看准确交接时间与月柱变化'],
  },
  {
    title: '八字反推日期',
    description: '根据已知四柱，在指定年份范围查找匹配的公历时段。',
    bullets: ['填写年、月、日、时四柱与查询年份', '核对换日口径', '结果时段包含起点、不包含终点'],
  },
] as const;
