const workflowSteps = [
  ...
  {
    title: '填写并查看结果',
    description: '排盘与占问都先填写资料，完成后进入独立结果页查看完整盘面或卦象。',
  },
  {
    title: '按需使用提示词',
...
const modeGuides = [
  {
    ...
    bullets: ['八字、紫微、星盘等均独立排盘', '完成一次排盘后自动保存到案例库'],
  },
  {
    title: '合盘',
    description: '看两个人的关系和匹配度。',
    bullets: ['填写双方出生信息', '双方资料会保存为一个合盘案例'],
  },
  {
    title: '占问',
    description: '围绕一个问题快速起卦。',
    bullets: ['先从侧栏选择算法', '输入页与结果页相互独立', '记录可在案例库继续查看'],
  },
  {
    title: '择时',
...
const commonQuestions = [
  ...
  },
  {
    ...
    answer: '可以。侧栏的“案例库”统一保存个人案例、合盘案例和占问记录。',
  },
  {
    question: '怎样固定常用案例？',
    answer: '在案例库中将个人或合盘案例置顶，它会优先显示在侧栏，方便直接切换。',
  },
] as const;
