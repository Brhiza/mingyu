...
- 大六壬：天盘、四课、三传、月将、贵人、旬空、课体与问题范围选择；输出起盘及四课九宗门主版本与异说边界，并逐传给出相对日干的六亲、有方向生克、相邻关系、月令旺衰及条件化旬空资料。当前自动识别 31 条完成原文与条件校勘的课体，其中进茹、退茹按三传逐支顺逆相连命中，进间、退间按三传每次隔一位顺逆命中，回环要求三传全见于四课上神，赘婿只取日支临干受干克且以日支发用的多源交集，游子只取三传皆为辰戌丑未且月建天马发用的多源共同条件，泆女与狡童只取卯酉发用及初末传天后、六合次序的共同结构，天狱只取囚死墓发用且天罡辰临六壬专用日本表的共同结构；九丑只取十个指定日柱且天盘大吉丑临本日支的严格条件，六仪、旬三奇只采用《六壬指南》明确的“发用”严格交集；非法或残缺课体上下文会失败关闭，官爵、龙首、龙战、芜淫等仍有版本条件分歧或缺少行年、旺衰层级等必要资料，继续关闭，未校勘的传统课体、神煞和断课目录不猜测命中。
