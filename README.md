...
项目网页目前按“排盘、合盘、占卜、择日”组织：排盘包含八字、紫微、住宅风水、七政四余，占卜包含六爻、梅花易数、奇门遁甲、大六壬、金口诀、小六壬、太乙神数、塔罗牌、雷诺曼和三山国王灵签。住宅风水为产品统一入口，后台分层计算八宅与玄空飞星后再合参；底层八宅、玄空仍可通过 API / MCP 单独调用。生肖流年继续作为底层算法与 API / MCP 能力供其他系统复用，不再提供独立网页入口。
...
- 住宅风水：产品统一入口，分层计算八宅人宅适配与玄空飞星宅运结构，再输出合参要点与建议；不生成综合吉凶总分。只需普通出生年月日+性别，或只填大门向屋内度数/山向，即可使用；可填建造/起运年。八宅负责命卦宅卦与四吉四凶，玄空负责运盘/山盘/向盘与到山到向，并在边界敏感时保留候选山向。底层仍可单独调用八宅与玄空。
- 七政四余：逐星输出回归黄经、项目恒星黄经、宿度、十二宫、庙旺与计算来源；七政、真交点、真莉莉丝和古法紫炁分层标注，地点及时区缺省会明确警告，相位只展示实际夹角、偏差与容许度等级，不输出强度百分比。
- 时间型占卜的应期只输出盘内相对节奏、触发条件与限制：奇门结合内外宫、庚格、空亡、马星、伏吟反吟，小六壬结合三宫推进、五行和月令；不再机械换算固定天数、周数或百分比。
...
- 历法层还可按日期、经纬度和历史时区输出太阳高度、真北方位角、视太阳正午、日出日落及民用/航海/天文曙暮光；西占和七政四余已接入，并保留极昼极夜、地平遮挡和大气折射限制。
...
- 六爻：京房八宫法排盘，包含纳甲、六亲、六神、世应、动变、空亡、日破、月破、化进神、化退神、六亲持世等信息；输出用神候选、原神忌神仇神作用链，以及逐爻月日、空破墓、动变支持与反证，不生成吉凶总分。
...
- 小六壬：大安、留连、速喜、赤口、小吉、空亡六宫起课；通行掌诀支持时间/数字/随机，华山派仅时间起课并输出完整课象（日干支六亲、旬空、驿马、桃花），以及起因、过程、结果、逐段五行、月令旺衰、现实触发条件与反证限制组成的结构化证据。
- 太乙神数：支持年计、月计、日计、时计、分计五种计式，分别使用积年、积月、积日、积时、积分及对应阴阳遁规则，输出太乙、文昌、始击、计神、主客定算、将参与十六神盘，并提供计算链、主证、辅证、反证和方法限制组成的结构化证据。
...
- 黄历择日：支持搬家入宅、订婚结婚、开业启动、签约合作、出行赴任、就医手术、考试学习、安葬修坟、修造动土等事项；按事项宜忌、参与人刑冲破害、时辰与现实限制分成可用、条件和慎用候选，不把内部排序分数包装成吉凶强度。
...
包覆盖能力：八字（含调候用神、格局、神煞、大运、命卦、小运、排盘边界预警、中国夏令时校正及透干根气、十神结构、合化评估等增强分析）、奇门遁甲（含节令背景、复合格局、方位应期）、六爻、大六壬、梅花易数、小六壬、紫微斗数、西洋占星、择日、雷诺曼、塔罗、三山国王灵签，以及住宅风水（八宅+玄空合参）、八宅、玄空飞星、生肖流年、太乙、七政四余和干支、五行、方位、神煞公共模块。
