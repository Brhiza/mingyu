...
项目目前覆盖八字排盘、紫微斗数、星盘、六爻、梅花易数、奇门遁甲、大六壬、小六壬、塔罗牌、雷诺曼、三山国王灵签、择日，以及八宅风水、生肖犯太岁、太乙神数、七政四余等场景，并尽量将结果拆分为机器可读的数据、用户可理解的摘要和适合大模型继续分析的提示词。
...
- 太乙神数：当前只开放已逐局核对的年家七十二局，输出积年、太乙、文昌、始击、计神、主客算与十六神盘；不再用年数公式冒充月、日、时家。
