...
- 奇门遁甲：输出值符、值使、日干、时干及已校勘格局所在宫的位置索引，逐宫保留门星神干、空亡、马星、宫间关系与反证，不用数字评分替代判断，也不自动指定用神、吉方、避方或应期。三奇六仪 81 种天地盘组合全部保留结构事实，11 项经《遁甲演义》逐条校勘的固定格自动进入传统格局；时家另按完整日柱识别《遁甲演义》《奇门遁甲统宗》《奇门法窍》互证的伏干格、飞干格，只登记中性结构，不继承兵占、出行或主客利弊断语。60 日柱 × 81 种天地盘组合已独立穷举，甲日按六甲旬首遁干复算；日干与时干位置索引另以 60 日柱 × 12 时辰真实生成盘验证，甲日、甲时均按六甲遁干定位；月家、年家不外推两项日干上下文格。
