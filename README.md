...
项目网页目前按“排盘、合盘、占卜、择日”组织：排盘包含八字、紫微、住宅风水、七政四余，占卜包含六爻、梅花易数、奇门遁甲、大六壬、小六壬、太乙神数、塔罗牌、雷诺曼和三山国王灵签。住宅风水为产品统一入口，后台分层计算八宅与玄空飞星后再合参；底层八宅、玄空仍可通过 API / MCP 单独调用。生肖流年继续作为底层算法与 API / MCP 能力供其他系统复用，不再提供独立网页入口。
