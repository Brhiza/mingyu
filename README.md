...
- 星盘排盘：西方占星完整排盘，包含太阳、月亮、上升星座与宫位、十大行星、逆行提示与主要相位分析；本命、行运和双盘相位输出角度偏差、容许度位置与紧密等级，不把归一化值包装成事件概率、匹配率或吉凶百分比。
...
- 太乙神数：支持年计、月计、日计、时计、分计五种计式，分别使用积年、积月、积日、积时、积分及对应阴阳遁规则，输出太乙、文昌、始击、计神、主客定算、将参与十六神盘。
