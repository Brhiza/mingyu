...
- 奇门遁甲：输出值符、值使、日干、时干及已校勘格局所在宫的位置索引，逐宫保留门星神干、空亡、马星、宫间关系与反证，不用数字评分替代判断，也不自动指定用神、吉方、避方或应期。三奇六仪 81 种天地盘组合全部保留结构事实，11 项经《遁甲演义》逐条校勘的固定格自动进入传统格局；时家另开放伏干格、飞干格、岁格和六庚值符临丙格勃四项中性上下文结构，乙奇到震三、丙奇到离九、丁奇到兑七三项中性升殿位置结构，以及三奇合开休生门并临太阴、九地、六合的真诈、重诈、休诈三项中性同宫结构，不继承兵占、出行、百事、用途或主客利弊断语。伏干、飞干按 60 日柱 × 81 种天地盘组合穷举，岁格按 60 年干支 × 81 种组合穷举，格勃按 60 时柱 × 9 种值符宫地盘干穷举，三奇升殿按 9 种天盘奇仪 × 9 宫共 81 组位置组合穷举，三诈按 9 种天盘奇仪 × 8 门 × 8 神共 576 组同宫组合穷举，并以转盘、飞盘真实生成盘独立复算；甲日、甲年按六甲旬首遁干处理。升殿实际取用仍须结合吉门、门迫与入墓；三诈缺少奇、门、神任一层时不命名；月格因“月干/月朔干”不一、时格因“本时干/仅三奇/庚值符管十时”不一、普通勃格因“丙临年月日时干/丙加值符庚”不一而继续失败关闭；月家、年家不外推这些时家结构。
