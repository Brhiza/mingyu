...
- 八字排盘：四柱、十神、藏干、纳音、神煞、大运、流年、旺衰、格局、用神与调候分析；支持按出生记录误差前后重排候选盘，输出稳定柱位和变化柱位；年限提示词可输出原局—大运—流年—流月—流日逐层合冲刑害破、伏吟、岁运并临与天克地冲证据；双盘可计算日主、日支、四柱交叉关系、双向十神、喜忌覆盖与结构化证据，支持传统派、盲派、新派流派指引。
...
- 八宅风水：站在大门处面向屋内输入指南针读数，自动换算二十四山坐向，再结合命卦生成大游年四吉四凶方；可声明磁北或真北、输入当地磁偏角与测量误差，并在误差跨越山向或宅卦边界时返回候选盘；结构化证据逐方比较命卦与宅卦的重合、同凶和异判，并明确户型、动线、采光通风及现场磁干扰限制。
...
- 生肖流年：按生肖年支与流年干支逐项计算值、冲、刑、害、破、三合、六合和年干五行辅助关系，输出计算链、主证、辅证、反证与信息量限制；旧版吉凶等级只作接口兼容，不作为提示词结论。
