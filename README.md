...
- 大六壬：天盘、四课、三传、月将、贵人、旬空、课体与问题范围选择；输出起盘及四课九宗门主版本与异说边界，并逐传给出相对日干的六亲、有方向生克、相邻关系、月令旺衰及条件化旬空资料。当前自动识别 23 条完成原文与条件校勘的课体，其中进茹、退茹只按三传逐支顺行或逆行相连命中，九丑只取十个指定日柱且天盘丑临本日支的严格条件，六仪、旬三奇只采用《六壬指南》明确的“发用”严格交集；非法或残缺课体上下文会失败关闭，未校勘的传统课体、神煞和断课目录不冒充已穷尽。
