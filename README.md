...
- 七政四余：输出七政四余十一星、命身十二宫、宿度、全部 55 组星对实际夹角、月相与出生时刻光照。七政、罗睺、计都和月孛采用现代天文位置，二十八宿用 28 颗真实距星在目标日期的黄经划界；紫炁保留《七政算内篇》古法均速模型，并明确区分位置精度层级。固定容许度吊照与简化庙旺表因缺少闭合原典依据而不自动判定。
