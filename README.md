...
项目网页目前按“排盘、合盘、占卜、择日”组织：排盘包含八字、紫微和住宅风水，占卜包含六爻、梅花易数、奇门遁甲、大六壬、金口诀、小六壬、太乙神数、塔罗牌、雷诺曼和三山国王灵签。住宅风水为产品统一入口，后台分层计算八宅与玄空飞星后再合参；底层八宅、玄空仍可通过 API / MCP 单独调用。生肖流年继续作为底层算法与 API / MCP 能力供其他系统复用，不再提供独立网页入口。七政四余在传统宿度坐标链重新校勘期间暂停，不输出近似盘。
...
- 紫微斗数：以 `iztro` 原生能力输出十二宫、星曜、亮度、四化、三方四正及本命、大限、流年、流月、流日、流时，并随结果披露实际安星、闰月、分年、运限月份、小限年龄和晚子时口径；三合派、飞星派、四化派选项只改变解读侧重点，不改底层安星。首批 9 条格局按《紫微斗数全书》固定版本逐条登记原文与可复算条件；原 84 条未校勘规则继续停用，未登记格局不作判断。
...
- 七政四余：完整传统盘暂时失败关闭。旧实现误把角宿起点固定为黄经 0°，古距度表合计 366.5 度，且缺少经校勘的二十八宿距星边界；独立紫炁均速函数仅保留供研究校勘。
...
包覆盖能力：八字（含调候用神、格局、神煞、大运、命卦、小运、排盘边界预警、中国夏令时校正及透干根气、十神结构、合化评估等增强分析）、奇门遁甲（含节令背景、复合格局、方位应期）、六爻、大六壬、梅花易数、小六壬、紫微斗数、西洋占星、择日、雷诺曼、塔罗、三山国王灵签，以及住宅风水（八宅+玄空合参）、八宅、玄空飞星、生肖流年、太乙和干支、五行、方位、神煞公共模块。七政四余模块仅保留失败关闭入口与独立紫炁研究函数，完整传统盘暂停。
