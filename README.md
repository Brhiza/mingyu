...
- 八字排盘：输出四柱、十神、藏干、纳音、神煞、大运、流年、月令司权、旺衰条件与格局依据；出生时间必须通过输入约束后才进入排盘，不生成模糊时间候选盘。未完成逐条来源、版本与适用边界校勘的自动用神、调候和病药规则已失败关闭，底层明确返回取用待定，由 AI 结合完整盘面与问题继续复核。年限提示词可输出原局—大运—流年—流月—流日逐层合冲刑害破、伏吟、岁运并临与天克地冲证据；双盘可计算日主、日支、四柱交叉关系、双向十神及喜忌资料缺口，支持传统派、盲派、新派流派指引。
...
- 六爻：京房八宫法排盘，包含纳甲、六亲、六神、世应、动变、空亡、日破、月破、化进神、化退神、六亲持世等信息；回头冲、动变五行关系、化空、化破与化扶可同时保留，变爻只回头作用本位动爻。三合按三爻齐动、两动一静、初三/四六爻动变、月日补局与虚一待用分别记录参与爻、空破墓和待值条件，同一爻的本支、变支不能冒充月日补局所需的两个活动爻；静爻逢月日合记合起，明动或暗动逢合记合绊，两活动爻相合记合好。输出分层用神候选、原神忌神仇神作用链，并逐引用记录用神有气/无根、原神忌神有力/无力及真实活动状态；另按月日、明暗动、旺相静爻、本位动变和飞伏事实返回直接生克、忌原接续相生及原忌受制得助的可追踪路径。路径允许并见，不按数量裁定最终有效性，也不生成吉凶总分或固定日期。
- 梅花易数：支持时间起卦、数字起卦、随机起卦，包含体用生克、四时旺衰、64卦完整爻辞，以及主卦、互卦、变卦逐阶段体用推进与支持、限制证据。
- 奇门遁甲：时家奇门默认转盘法，可通过 API 参数请求飞盘法；定局默认拆补法，也可请求置闰法。包含天地人神四盘、值符值使、格局标签（含入墓、击刑、伏吟反吟、门迫等）、节令背景、已校勘组合、位置索引与全部九宫宫对。八门余气固定采用《奇门遁甲统宗》五态月令版，十干迫制只保留奇仪落宫受克事实；通用入口不自动套用出军交战、星宫门宫主客、迷路、下营等缺少专项情境或存在版本冲突的规则，原始九宫、奇仪、星门神事实继续完整提供。
...
包覆盖能力：八字（含四柱、月令司权、旺衰条件、格局、神煞、大运、命卦、小运、排盘边界预警、中国夏令时校正及透干根气、十神结构、合化评估等增强分析；未校勘的自动用神、调候与病药规则失败关闭）、奇门遁甲（含节令背景、九宫原始事实、位置索引、全部宫对五行关系及已校勘固定格，不自动指定用神或生成方位应期）、六爻、大六壬、梅花易数、小六壬、紫微斗数、西洋占星、七政四余、择日、雷诺曼、塔罗、三山国王灵签，以及住宅风水（八宅与玄空分层资料）、八宅、玄空飞星、生肖流年、太乙和干支、五行、方位、神煞公共模块。
