...
- 八字排盘：输出四柱、十神、藏干、纳音、神煞、大运、流年、月令司权、旺衰条件与普通月令格局依据；出生时间必须通过输入约束后才进入排盘，不生成模糊时间候选盘。结果保存规范化公农历出生输入、真太阳时资料、完整神煞口径、中国夏令时开关和生成时间；公开证据、格式化、合盘、岁运与提示词只凭这些来源重建，不采信旧四柱、格局、神煞、大运、合盘或岁运派生字段，来源缺失、夹带、矛盾或非法时失败关闭。岁运入口只接受层级、运序及年月日原始选择，干支、十神、触发关系与提示词证据重新计算。底层只登记月令、司令、根气、藏透、成局及生克制化事实，不自动裁定整体身强身弱；专旺与从格在全局条件和来源闭合前失败关闭。未完成逐条来源、版本与适用边界校勘的自动用神、调候和病药规则同样失败关闭，明确返回取用待定，由 AI 结合完整盘面与问题继续复核。年限提示词可输出原局—大运—流年—流月—流日逐层合冲刑害破、伏吟、岁运并临与天克地冲证据；双盘可计算日主、日支、四柱交叉关系、双向十神及喜忌资料缺口，支持传统派、盲派、新派流派指引。
- 紫微斗数：以 `iztro` 原生能力输出十二宫、星曜、亮度、四化、三方四正及本命、大限、流年、流月、流日、流时，并随结果披露实际安星、闰月、分年、运限月份、小限年龄和晚子时口径；三合派、飞星派、四化派选项只改变解读侧重点，不改底层安星。结果的 `generation` 只保存传统时辰或真太阳时原始出生资料、完整排盘口径、生成时间、实际范围与轻量模式；公开结果和提示词会据此重建，不采信旧宫位、星曜、四化、运限、格局、证据或提示词。来源缺失、夹带、矛盾或非法时失败关闭。固定版本传统目录现登记 87 项，其中 55 条具备原文与可复算条件，32 项因原文含糊或依赖运限只登记边界、不伪造命中；原 84 条未校勘项目规则继续停用，目录外格局不作判断。
