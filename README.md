...
- 紫微斗数：以 `iztro` 原生能力输出十二宫、星曜、亮度、四化、三方四正及本命、大限、流年、流月、流日、流时，并随结果披露实际安星、闰月、分年、运限月份、小限年龄和晚子时口径；三合派、飞星派、四化派选项只改变解读侧重点，不改底层安星。当前 18 条格局按《紫微斗数全书》固定版本逐条登记原文与可复算条件；原 84 条未校勘规则继续停用，未登记格局不作判断。
