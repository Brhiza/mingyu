...
- 六爻：京房八宫法排盘，包含纳甲、六亲、六神、世应、动变、空亡、日破、月破、化进神、化退神、六亲持世等信息；回头冲、动变五行关系、化空与化扶可同时保留，变爻只回头作用本位动爻。三合按三爻齐动、两动一静、初三/四六爻动变、月日补局与虚一待用分别记录参与爻、空破墓和待值条件，同一爻的本支、变支不能冒充月日补局所需的两个活动爻；静爻逢月日合记合起，明动或暗动逢合记合绊，两活动爻相合记合好。输出分层用神候选、原神忌神仇神作用链，以及按用神、原神、忌神辨向的病药应期条件；整卦冲合与三合均须结合用忌、世爻和旺衰辨向，不生成吉凶总分或固定日期。
